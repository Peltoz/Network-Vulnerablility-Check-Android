...
public class ResultListViewAdapter extends BaseExpandableListAdapter
{
    ...
    public ResultListViewAdapter(Context context, ArrayList<String> parentList, HashMap<String, ArrayList<ChildListData>> childHashMap){
